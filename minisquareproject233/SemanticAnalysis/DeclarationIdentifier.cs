...
namespace Compiler.SemanticAnalysis
{
    ...
    public class DeclarationIdentifier
    {
        ...
        private void PerformIdentificationOnDoIfCommand(DoIfCommandNode doIfCommand)
        {
            PerformIdentification(doIfCommand.DoCommand);
            PerformIdentification(doIfCommand.Expression);
            PerformIdentification(doIfCommand.ElseCommand);
        }
        ...
        {       
            PerformIdentification(repeatCommand.RepeatCommand);
        ...
        {
            PerformIdentification(constDeclaration.TypeDenoter);        // may not be necessary
